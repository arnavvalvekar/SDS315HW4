...
brown_chi_values = sapply(letter_frequencies, compute_chi, expected_freq = english_freq)
...
Based on the table and the p_values, we can determine that sentence 6 is most likely generated by an LLM, as it has the lowest p_value out of all of these sentences by a decent amount, indicating it has the strongest deviation from normal English letter distribution due to the watermarking of the LLM. 
